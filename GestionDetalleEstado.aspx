            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Clase" SortExpression="NombreClase">
                    <ItemTemplate>
                        ...
                        <%-- Guardar el ID de clase para edición --%>
                     ...
                     <EditItemTemplate>
                         <asp:DropDownList ID="ddlEditClase" runat="server" CssClass="form-select edit-control"
                             ...
                             SelectedValue='<%# Bind("IdClase") %>'>
                         </asp:DropDownList>
                         <%-- No se requiere validador si se permite NULL, pero sí si es obligatorio --%>
                         <%-- <asp:RequiredFieldValidator ID="rfvEditClase" runat="server" ControlToValidate="ddlEditClase" InitialValue="0" ErrorMessage="Seleccione clase." CssClass="text-danger small" Display="Dynamic" ValidationGroup="EditValidation">*</asp:RequiredFieldValidator>--%>
                     </EditItemTemplate>
                </asp:TemplateField>
        ...
        <div class="row g-3 align-items-end">
             <div class="col-md-5">
                 ...
                 <asp:DropDownList ID="ddlNuevaClase" runat="server" CssClass="form-select" DataValueField="IdClase" DataTextField="Nombre" AppendDataBoundItems="true">
                      <asp:ListItem Text="-- Sin Clase Específica --" Value="0"></asp:ListItem> <%-- Opción para NULL --%>
                 </asp:DropDownList>
